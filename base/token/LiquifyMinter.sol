...
contract LiquifyMinter is IMinter {
  ...
  /// @dev Decrease initialStubCirculationSupply by 3% per week.
  ///      Decreasing only if circulation supply lower that the stub circulation
  uint internal constant _INITIAL_CIRCULATION_DECREASE = 97;
  ...
  uint internal constant _START_BASE_WEEKLY_EMISSION = 2_000_000e18; //TODO to be fixed depends of VIP round & Presale round
